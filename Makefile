...
NDK_ROOT ?= $(shell ls -1d $(ANDROID_HOME)/ndk/* 2>/dev/null | grep 25.2.9519653)
...
ANDROID_SDK_PACKAGES := 'platforms;android-34' 'extras;android;m2repository' 'ndk;25.2.9519653' 'platform-tools' 'build-tools;34.0.0'
